...
export class AuthService {
  ...
  loginWithPassword(userName: string, password: string, rememberMe?: boolean,selectedDomain?: string) {
    if (this.isLoggedIn) {
      this.logout();
    }

    return this.oidcHelperService.loginWithPassword(userName, password,selectedDomain)
