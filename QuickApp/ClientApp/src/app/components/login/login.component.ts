...
export class LoginComponent implements OnInit, OnDestroy {
  ...
  login() {
    ...
    this.authService.loginWithPassword(this.userLogin.userName, this.userLogin.password, this.userLogin.rememberMe,this.userLogin.domain)
      .subscribe(
        user => {
          setTimeout(() => {
