...
@Component({
  selector: 'app-user-info-authorization',
  templateUrl: './user-info-authorization.component.html',
  styleUrls: ['./user-info-authorization.component.scss']
})
export class UserInfoAuthorizationComponent implements OnInit {
