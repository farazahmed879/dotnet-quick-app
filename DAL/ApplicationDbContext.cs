...
namespace DAL
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<GridUserManagementVM>()
            .Property(p => p.AuthSignatory).IsRequired(required: false);
            builder.Entity<GridUserManagementVM>()
            .Property(p => p.AccountType).IsRequired(required: false);
            builder.Entity<GridUserManagementVM>()
            .Property(p => p.AccountDescription).IsRequired(required: false);
            builder.Entity<GridUserManagementVM>()
            .Property(p => p.Reference).IsRequired(required: false);
            builder.Entity<GridUserManagementVM>()
